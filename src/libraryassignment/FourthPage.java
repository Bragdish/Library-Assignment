...
import static libraryassignment.SecondPage.conn;
...
public class FourthPage extends javax.swing.JFrame implements Runnable {
    ...
    String output = "";
    String available = "";
    String[] columnNames1 = {"Title", "Book ID", "Branch ID", "Total", "Available"};
    String[] columnNames2 = {"Book ID", "Title", "Branch ID", "Date Out", "Date Due", "Fine"};
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (flag == 1) {
            ...
            try {
                ...
                branch_id = (String) jTable1.getValueAt(selectedRow, 2);
                ...
                if (available.equals("0")) {
                    ...
                    try {
                        ...
                        //String q;
                        stmt.executeQuery("use library_project;");
                        stmt.executeUpdate("INSERT INTO book_loans (book_id,branch_id,card_no,date_out,due_date) VALUES(\"" + book_id + "\"," + branch_id + ",\"" + eno + "\",CURRENT_DATE(),DATE_ADD(CURRENT_DATE(), INTERVAL 14 DAY));");
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT b.title, b.book_id, lb.branch_id, "
                        ...
                        + "where b.book_id like \"%" + jTextField1.getText()
                ...
                while (rs.next()) {
                    ...
                    model1.addRow(new Object[]{title, book_id, branch_id, no_of_copies, available});
                    output = output + title + "\t" + book_id + "\t" + branch_id + "\t" + no_of_copies + "\t" + available + "\n";
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (Double.parseDouble(fine) == 0.0) {
            ...
            try {
                ...
                stmt.executeQuery("use library_project;");
                stmt.executeUpdate("DELETE FROM book_loans WHERE book_id=\"" + book_id + "\" AND branch_id=" + branch_id + " AND card_no=\"" + eno + "\";");
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    model2.addRow(new Object[]{book_id, title, branch_id, date_out, date_due});
                    output = output + book_id + "\t" + title + "\t" + branch_id + "\t" + date_out + "\t" + date_due + "\n";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (date1.compareTo(date2) <= 0) {
                    //System.out.println(date1.compareTo(date2) + "dateString1 is an earlier date than dateString2");
                    int diffInDays = (int) ((date1.getTime() - date2.getTime()) / (1000 * 60 * 60 * 24));
                    //System.out.println("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" + diffInDays);
